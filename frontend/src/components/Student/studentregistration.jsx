      ...
      <div style={s.card}>
        ...
        {step === 1 && (
          <div style={s.formSection}>
            ...
            <InputField
              label="University"
              icon={<FaUniversity color="#9ca3af" />}
            ...
            <label style={s.label}>Short Bio <span style={{ color: "#9ca3af", fontWeight: 400 }}>(optional)</span></label>
            <textarea
        ...
        {step === 2 && (
          <div style={s.formSection}>
            <div style={s.chipSection}>
              <label style={s.label}>💡 Skills <span style={s.hint}>({selectedSkills.length} selected)</span></label>
            ...
            <div style={{ ...s.chipSection, marginTop: 24 }}>
              <label style={s.label}>⭐ Interests <span style={s.hint}>({selectedInterests.length} selected)</span></label>
              <div style={s.chipGrid}>
...
const s = {
  ...
  subheading: {
    fontSize: 14, color: "#6b7280", marginBottom: 28, lineHeight: 1.5,
  },
  stepRow: {
